...
public class DecoratedPlanDefinitionProcessor {
  ...
  protected MyOperationsParametersParser operationParametersParser;
  ...
  public DecoratedPlanDefinitionProcessor(FhirContext fhirContext, FhirDal fhirDal, LibraryProcessor libraryProcessor, ExpressionEvaluator expressionEvaluator,
      ActivityDefinitionProcessor activityDefinitionProcessor, MyOperationsParametersParser operationParametersParser) {
    ...
    for (PlanDefinition.PlanDefinitionActionDynamicValueComponent dynamicValue : action.getDynamicValue()) {
      ...
      if (dynamicValue.getExpression().hasLanguage()) {
        ...
        if (dynamicValue.hasPath() && dynamicValue.getPath().equals("$this")) {
          ...
          try {
        	String propertyType = dynamicValue.getPath().substring(dynamicValue.getPath().indexOf(".")+1);
        	if ("extension".equals(propertyType) && result instanceof StringType) {
