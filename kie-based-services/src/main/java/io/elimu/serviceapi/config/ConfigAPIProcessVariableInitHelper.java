...
public class ConfigAPIProcessVariableInitHelper extends ProcessVariableInitHelper {
	...
	public Map<String, Object> initVariables(String client, Dependency dep, Properties config) {
		...
		serviceProperty.putAll(new ConfigAPIUtil().getConfig(env, client, appName));
